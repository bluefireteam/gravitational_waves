...
class Palette extends BasicPalette {
  ...
  static const PaletteEntry player =
      const PaletteEntry(const Color(0xFFFFFFFF));
  static const PaletteEntry playerHurt =
      const PaletteEntry(const Color(0x66FFFFFF));
  static const PaletteEntry playerShine =
      const PaletteEntry(const Color(0xBB00A8F3));
  static const PaletteEntry playerDebugRect =
      const PaletteEntry(const Color(0xFFFF2266));
